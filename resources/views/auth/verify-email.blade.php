<x-guest-layout>
    <div class="mb-4 text-sm text-gray-600 dark:text-gray-400">
        {{ __('Es necesario que confirmes tu cuenta antes de continuar, revisa tu email y presiona el enalce de verificacion') }}
    </div>

    @if (session('status') == 'verification-link-sent')
        <div class="mb-4 font-medium text-sm text-green-600 dark:text-green-400">
            {{ __('Hemos enviado el email de confirmacion a la cuenta que colocaste') }}
        </div>
    @endif
